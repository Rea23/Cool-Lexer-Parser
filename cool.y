...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <classes> classes_list
    %type <class_> class
    %type <features> features_list			/* can be empty */
    %type <feature> feature
    %type <formals> formals_list
    %type <formal> formal				/* arguments separated by comma */
    %type <cases> cases_list
    %type <case_> case
    %type <expression> let
    %type <expressions> expressions_param_list		/* expression(s) separated by comma */
    %type <expressions> expressions_smcln_list  	/* expression(s) separated by semicolon */
    ...
    classes_list : class  /* single class */
    		 	{ $$ = single_Classes($1);
    		   	  parse_results = $$; 
			}

	       | classes_list class  /* several classes */
    ...
    feature : OBJECTID '(' formals_list ')' ':' TYPEID '{' expression '}' ';'
		   { $$ = method($1, $3, $6, $8); }
    ...
    expressions_param_list : expression
    			     	{ $$ = single_Expressions($1); }
    ...
    expression : OBJECTID ASSIGN expression 
		...
		/* dispatch: normal, static, omitted self */
    	       ...
    	       | expression '.' OBJECTID '(' expressions_param_list ')' 
    			{ $$ = dispatch($1, $3, $5); }
